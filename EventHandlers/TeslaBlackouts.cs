...
namespace AnomalousZonePlugin.EventHandlers
{
    internal sealed class TeslaBlackouts
    {
        ...
        {
            if (ev.Player.Role.Team == Team.FoundationForces || RoomName.ContainsKey(ev.Player.CurrentRoom) || zone.ContainsKey(ZoneType.HeavyContainment) ||
                (ev.Player.Role.Type == RoleTypeId.Scp3114 && team == Team.FoundationForces))
            {
