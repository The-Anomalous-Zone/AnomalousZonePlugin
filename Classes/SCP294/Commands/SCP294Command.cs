...
namespace AnomalousZonePlugin.Classes.SCP294.Commands
{
    ...
    public class SCP294Command : ICommand
    {
        ...
        public string Description { get; } = "<color=#0d98ba>Look at SCP-294. Usage: .scp294 <drink-name> OR .scp294 player <player></color>";
                            ...
                            if (drinkName.ToLower() == String.Join(" ", arguments.Where(s => !String.IsNullOrEmpty(s))).ToLower())
                            {
                                ...
                                if (customDrink.BackfireChance > failNumber)
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        player.ShowHint($"<color=#0d98ba>You feel queasy, as if you're missing some of your body's contents...</color>\n<size=20><color=#ff0000>(SCP-294 Backfired, Dispensing a Cup of {player.Nickname})</size>", 5);
                                ...
                                else
                                {
                                    ...
                                    response = $"SCP-294 Started Dispensing a Drink of {drinkName}. {(Plugin.Instance.Config.ForceRandom ? "(Server Forced Random Drink)" : "")}";
                                    SCP294Object.SetSCP294Uses(scp294, SCP294.Instance.SCP294UsesLeft[scp294] - 1);
                                    return true;
                                }
                            }
